...
class ResBlock(nn.Module):
    ...
    def __init__(self, input_dim=64, output_dim=64,
        ...
        self.conv1 = Conv2d(in_channels=input_dim, out_channels=output_dim,
                            kernel_size=ks,
                            stride=reduce)
        self.bn2 = nn.BatchNorm2d(output_dim)
        self.conv2 = Conv2d(in_channels=output_dim, out_channels=output_dim,
                            kernel_size=ks,
                            )
        self.conv3 = Conv2d(in_channels=input_dim, out_channels=output_dim,
                            kernel_size=ks,
                            stride=reduce)
...
class Decoder(nn.Module):
    ...
    def __init__(self, input_dim=256, level=4, channels=1):
        ...
        self.conv1 = nn.ConvTranspose2d(in_channels=input_dim,
                                        out_channels=256,
                                        kernel_size=3, padding=1,
                                        stride=2)
        self.conv2 = Conv2d(in_channels=256, out_channels=channels,
                            kernel_size=3,
                            stride=1)
        self.conv3 = nn.ConvTranspose2d(in_channels=256, out_channels=128,
                                        kernel_size=3, padding=0,
                                        stride=2)
        self.conv4 = Conv2d(in_channels=128, out_channels=channels,
                            kernel_size=3,
                            stride=1)
        self.conv5 = nn.ConvTranspose2d(in_channels=128, out_channels=channels,
...
class Discriminator(nn.Module):
    ...
    def __init__(self, level=4, bn=False):
        ...
        self.conv1 = Conv2d(in_channels=3, out_channels=128,
                            kernel_size=3,
                            stride=2)
        self.conv2 = Conv2d(in_channels=128, out_channels=256,
                            kernel_size=3,
                            stride=2)
        self.conv3 = Conv2d(in_channels=256, out_channels=256,
                            kernel_size=3,
                            stride=2)
        ...
        self.conv5 = Conv2d(in_channels=256, out_channels=256,
                            kernel_size=3,
                            stride=2)
        self.fla = nn.Flatten()
